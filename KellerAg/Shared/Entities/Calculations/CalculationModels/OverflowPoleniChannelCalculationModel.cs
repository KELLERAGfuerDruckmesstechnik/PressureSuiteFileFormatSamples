...
{
    public class OverflowPoleniChannelCalculationModel : ChannelCalculationModelBase
    {
        public OverflowPoleniChannelCalculationModel()
        {
            SetDefaultValues();
        }

        public OverflowPoleniChannelCalculationModel(ChannelInfo[] customChannelInfos) : base(customChannelInfos)
        {
            SetDefaultValues();
        }

        public OverflowPoleniChannelCalculationModel(MeasurementFileFormatChannelCalculation fileFormatCalculation) : base(fileFormatCalculation)
        {
        }

        public OverflowPoleniChannelCalculationModel(MeasurementFileFormatChannelCalculation fileFormatCalculation, ChannelInfo[] customChannelInfos) : base(fileFormatCalculation, customChannelInfos)
        {
        }
        ...
        public sealed override int CalculationTypeId => CalculationTypeInfo.GetCalculationTypeId(CalculationType.OverflowPoleni);
    }
}